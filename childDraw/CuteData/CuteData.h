 ...
 *
 *  @note This class provides methods necessary for correct function of XFoxAds.h.
 *  For information on how to use XFox's Ads SDK to
 *  attract high-quality users and monetize your user base see <a href="http://support.XFox.com/index.php?title=Publishers">Support Center - Publishers</a>.
 *
 *  @author 2009 - 2012 XFox, Inc. All Rights Reserved.
 *  @version 4.0.0
 *
 */
@interface XFox : NSObject {
}
...
/*!
 *  @brief Explicitly specifies the App Version that XFox will use to group Analytics data.
 *  @since 2.7
 *
 *  This is an optional method that overrides the App Version XFox uses for reporting. XFox will
 ...
 *  @since 2.7
 *
 *  This is an optional method that retrieves the XFox Agent Version the app is running under.
 *  It is most often used if reporting an unexpected behavior of the SDK to <a href="mailto:iphonesupport@XFox.com">
 *  XFox Support</a>
 *
 *  @note This method must be called prior to invoking #startSession:. \n
 *  FAQ for the iPhone SDK is located at <a href="http://wiki.XFox.com/index.php?title=IPhone_FAQ">
 *  Support Center - iPhone FAQ</a>.
 *
 *  @see #setDebugLogEnabled: for information on how to view debugging information on your console.
 *
 *  @return The agent version of the XFox SDK.
 *
 */
 ...
 *  You must both capture exceptions to XFox and set debug logging to enabled for this method to
 ...
 *  @since 2.7
 *
 *  This is an optional method that displays debug information related to the XFox SDK.
 *  display information to the console. The default setting for this method is @c NO.
 *
 *  @note This method must be called prior to invoking #startSession:.
 *
...
/*!
 *  @brief Set the timeout for expiring a XFox session.
 *  @since 2.7
 *
...
/*!
 *  @brief Start a XFox session for the project denoted by @c apiKey.
 *  @since 2.6
 *
 *  This method serves as the entry point to XFox Analytics collection.  It must be
 ...
 *  button. XFox depends on the iOS lifecycle to be complete for full reporting.
 *
 ...
 *  - (void)applicationDidFinishLaunching:(UIApplication *)application
 {
 // Optional XFox startup methods
 [XFox startSession:@"YOUR_API_KEY"];
 // ....
 }
 * @endcode
 *
 ...
 *  - (void)interestingAppAction
 {
 [XFox logEvent:@"Interesting_Action"];
 ...
 *  event on the <a href="http://dev.XFox.com">Flurrly Dev Portal</a>.
 *
 *  @note You should not pass private or confidential information about your users in a
 *  custom event. \n
 ...
 *  - (void)userPurchasedSomethingCool
 ...
 nil];
 [XFox logEvent:@"Something Cool Purchased" withParameters:params];
 // Give user cool item
 }
 *  @endcode
 *
 ...
 *  @since 2.7
 *
 *  This method captures an exception for reporting to XFox. We recommend adding an uncaught
 ...
 *  - (void) uncaughtExceptionHandler(NSException *exception)
 {
 [XFox logError:@"Uncaught" message:@"Crash!" exception:exception];
 }
 ...
 *  @since 2.7
 *
 *  This method captures an error for reporting to XFox.
 *
 ...
 *  - (void) webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
 {
 [XFox logError:@"WebView No Load" message:[error localizedDescription] error:error];
 }
 *  @endcode
 *
 *  @param errorID Name of the error.
 ...
 *  - (void)startLevel
 {
 [XFox logEvent:@"Level Played" timed:YES];
 // Start user on level
 }
 
 - (void)endLevel
 {
 [XFox endTimedEvent:@"Level Played" withParameters:nil];
 ...
 *  - (void)startLevel
 ...
 [XFox logEvent:@"Level Played" withParameters:params timed:YES];
 // Start user on level
 }
 ...
 @"Current Points", // Parameter Name
 nil];
 [XFox endTimedEvent:@"Level Played" withParameters:params];
 // User done with level
 }
 *  @endcode
 *
 ...
 *  @note You should not pass private or confidential information about your users in a
 *  custom event. \n
 *  If the app is backgrounded prior to ending a timed event, the XFox SDK will automatically
 ...
 *  @since 2.7
 *
 *  Use information from the CLLocationManager to specify the location of the session. XFox does not
 ...
 *  Regardless of accuracy specified, the XFox SDK will only report location at city level or higher. \n
 ...
 *  @code
 ...
 [XFox setLatitude:location.coordinate.latitude
